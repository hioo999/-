...
class ImageSubConfig(BaseModel):
    ...
    api_key: Optional[str] = Field(default=None, description="Image generation model/workflow API Key (optional)")
...
class VideoSubConfig(BaseModel):
    ...
    api_key: Optional[str] = Field(default=None, description="Video generation model/workflow API Key (optional)")
